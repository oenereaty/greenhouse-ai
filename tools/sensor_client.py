...
발표용 "오늘" 고정 날짜는 tools/demo_clock.py에서 관리한다(kma_client.py의 AWS
실측치도 같은 날짜를 쓴다 — 두 곳에 따로 하드코딩하면 날짜를 바꿀 때 한쪽만
고치는 실수가 나기 쉬워 단일 출처로 모았다, 2026-07-10).
"""
import csv
import math
import random
...
from tools.demo_clock import demo_now as _demo_now
